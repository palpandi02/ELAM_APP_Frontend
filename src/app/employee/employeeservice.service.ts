...
export class EmployeeserviceService {
  ...
  private baseUrl = 'http://localhost:9091/employees';
  ...
  private fetchEmployees(): void {
    ...
    this.httpClient.get<Employee[]>(`${this.baseUrl}/getAll`, { headers })
      .pipe(
        map(response => {
  ...
  getEmployeesFromBackend(): Observable<Employee[]> {
    ...
    return this.httpClient.get<Employee[]>(`${this.baseUrl}/getAll`, { headers }).pipe(
      map(response => {
        console.log('Employees fetched successfully', response);
  ...
  updateEmployee(employee: Employee): Observable<Employee> {
    ...
    return this.httpClient.put<Employee>(`${this.baseUrl}/update/${employee.id}`, employee, { headers })
      .pipe(
        map(response => {
  ...
  deleteEmployee(id: number): Observable<void> {
    ...
    return this.httpClient.delete<void>(`${this.baseUrl}/delete/${id}`, { headers })
      .pipe(
        map(() => {
